...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [_FN] = LAYOUT_ansi_encoder(
        _______, KC_MYCM, KC_WHOM, KC_CALC, KC_MSEL, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_MUTE, KC_VOLD, KC_VOLU, _______, KC_INS,           _______, _______, _______,
    ...
    [_CAPS] = LAYOUT_ansi_encoder(
        _______,  KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F21,   KC_F22, KC_F23, KC_F24,  _______,          KC_BTN1, KC_WH_U, KC_WH_D,
...
const keypos_t encoder_cw[ENCODERS] = ENCODERS_CW_KEY;
const keypos_t encoder_ccw[ENCODERS] = ENCODERS_CCW_KEY;
